...
<head>
    ...
    <title>Add Stock In - Coffee Shop</title>
    ...
    <div class="max-w-3xl mx-auto px-6 py-8">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-500 mt-1">
                Record a new incoming ingredient stock.
            </p>
            ...
            <form action="{{ route('stock-ins.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        ...
                        class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('notes') }}</textarea>
