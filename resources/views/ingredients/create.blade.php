...
<head>
    ...
    <title>Add Ingredient - Coffee Shop</title>
            ...
            <form action="{{ route('ingredients.store') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <textarea
                        ...
                        class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Example: ₱450 per kilogram of coffee beans.
                    </p>
