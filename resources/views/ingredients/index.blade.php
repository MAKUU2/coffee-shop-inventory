...
<head>
    ...
    <title>Ingredients - Coffee Shop Inventory</title>
...
<body class="bg-stone-100 min-h-screen text-gray-800 antialiased">
    ...
    <main class="lg:ml-64 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 lg:mb-8">
            <div>
                ...
                <p class="text-sm text-stone-500 mt-1 tabular-nums">
                    {{ $ingredients->count() }} {{ $ingredients->count() == 1 ? 'ingredient' : 'ingredients' }} tracked
                </p>
            </div>
            <div class="flex flex-wrap gap-2 sm:gap-3">
                <a
                    href="{{ route('stock-ins.create') }}"
                    class="inline-flex items-center gap-2 rounded-lg bg-white hover:bg-stone-50 text-stone-800 text-sm font-medium px-4 sm:px-5 py-2.5 border border-stone-200 shadow-sm transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-600 focus-visible:ring-offset-2">
        ...
        @endif
        <!-- Ingredients Table -->
        <section class="bg-white rounded-xl shadow-sm border border-stone-200/70 overflow-hidden" aria-label="Ingredient list">
                ...
                <div class="flex items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="text-xs sm:text-sm text-stone-500 mt-0.5">
                            Raw materials with stock levels and status
                        </p>
                    </div>
                </div>
            </div>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-stone-100">
                        ...
                        <tr class="hover:bg-stone-50/70 transition">
                            ...
                            <!-- Stock -->
                            <td class="px-5 lg:px-6 py-4 text-right font-medium text-stone-800 tabular-nums whitespace-nowrap">
                                {{ $ingredient->stock }}
                                <span class="font-normal text-stone-500">{{ $ingredient->unit }}</span>
                            </td>
                            <!-- Minimum Stock -->
                            <td class="px-5 lg:px-6 py-4 text-right text-stone-600 tabular-nums whitespace-nowrap">
                                {{ $ingredient->minimum_stock }}
                                <span class="font-normal text-stone-400">{{ $ingredient->unit }}</span>
                            </td>
                            <!-- Cost -->
                            ...
                            <td class="px-5 lg:px-6 py-4 whitespace-nowrap">
                                ...
                                @else
                                <span class="inline-flex items-center gap-1.5 bg-emerald-50 border border-emerald-200 text-emerald-700 px-2.5 py-1 rounded-full text-xs font-semibold">
