...
<head>
    ...
    <title>Edit Stock Out - Coffee Shop Inventory</title>
            ...
            <form action="{{ route('stock-outs.update', $stockOut) }}"
                ...
                <div class="mb-6">
                    ...
                    <textarea name="notes"
                        ...
                        class="w-full border border-stone-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-stone-800 focus:border-stone-800">{{ old('notes', $stockOut->notes) }}</textarea>
                </div>
                <!-- Buttons -->
