...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="max-w-3xl mx-auto px-6 py-10">
        ...
        <div class="bg-white rounded-xl shadow p-6">
            ...
            <form action="{{ route('stock-outs.update', $stockOut) }}"
                method="POST">
                ...
                <div class="mb-5">
                    ...
                    <select name="ingredient_id"
                        ...
                        <option value="{{ $ingredient->id }}"
                            {{ old('ingredient_id', $stockOut->ingredient_id) == $ingredient->id ? 'selected' : '' }}>
                ...
                <div class="mb-5">
                    ...
                    <input type="date"
                        ...
                        value="{{ old('stock_out_date', $stockOut->stock_out_date->format('Y-m-d')) }}"
                ...
                <div class="mb-6">
                    ...
                    <textarea name="notes"
                        ...
                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-red-500 focus:border-red-500">{{ old('notes', $stockOut->notes) }}</textarea>
                ...
                <div class="flex gap-3">
                    ...
                    <button type="submit"
                        class="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-5 py-3 rounded-lg font-medium">
